<?php	
    ...
    elseif($objeto->sys_section=="write")
	{
		...
		#$objeto->__PRINT_R(substr($objeto->sys_fields["trabajador_departamento_id"]["value"],0,6));
		#$objeto->__PRINT_R($objeto->lugar(substr($objeto->sys_fields["trabajador_departamento_id"]["value"],0,6)));
	...
	$objeto->words["module_title"]              ="$module_title Licencia";
