<?php
	class incapacidad extends general
	{   
		##############################################################################	
		##  Propiedades	
		##############################################################################
		...
		var $sys_fields		=array( 
			...
			"fecha_calificacion"	    =>array(
				"title"             => "Fecha de Calificacion",			    			    
				"type"              => "date",			
			),
			"fecha_cita"	    =>array(
				"title"             => "Fecha de Cita",			    
			...
			"texto_calificacion"	    =>array(
				"title"             => "Calificado como",			    
				"type"              => "input",			
			),						
			...
			"patron_locacion"	    =>array(
				"title"             => "Locacion",			    
				"type"              => "input",			
			),					
			"patron_domicilio"	    =>array(
				"title"             => "Domicilio Patron",			    
				"type"              => "input",			
			),					
			"f_carta_realizada"	    =>array(
				"title"             => "Cartas realizadas",			    
				"type"              => "date",			
			),			
